...
lazy val `kyo-tapir` =
    crossProject(JVMPlatform)
        ...
        .settings(
            `kyo-settings`,
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-core"         % "1.11.2",
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.11.2"
        )
...
lazy val `kyo-caliban` =
    crossProject(JVMPlatform)
        ...
        .settings(
            ...
            libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.11.2" % Test
        )
